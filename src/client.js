  ...
  factory: (require) => {
    ...
    const I18N = {
      zh: {
        ...
        typeBundle: 'DSH 插件', typePack: '扩展包', downloads: '下载量', stars: '星标', forks: 'Fork 数',
      ...
      en: {
        ...
        typeBundle: 'DSH plugin', typePack: 'Pack', downloads: 'Downloads', stars: 'Stars', forks: 'Forks',
        ...
        return h('div', { className: 'dshm-card', key: item.id },
          ...
          h('div', { className: 'dshm-card-stats' },
            ...
            (typeof item.forks === 'number' && item.forks > 0)
              ? h('span', { title: t('forks') },
                  h('svg', { width: 13, height: 13, viewBox: '0 0 16 16', fill: 'none', stroke: 'currentColor', strokeWidth: 1.6 },
                    h('circle', { cx: 4.5, cy: 3.5, r: 1.8 }),
                    h('circle', { cx: 4.5, cy: 12.5, r: 1.8 }),
                    h('circle', { cx: 11.5, cy: 5.5, r: 1.8 }),
                    h('path', { d: 'M4.5 5.3v5.4M11.5 7.3c0-4-2.5-4.5-5-3.6', strokeLinecap: 'round' }),
                  ),
                  ' ' + fmtNum(item.forks))
              : null,
