...
const INSTALL_SPEC = 'github:losebird/dsh-plugin-market#v0.1.46'
...
function WhaleMark({ size = 22 }) {
  return (
    <svg width={Math.round(size * 143 / 23)} height={size} viewBox="0 0 143 23" aria-hidden="true" color="#4176E6">
...
function Faq() {
  const { t } = useLang()
  const items = [
    { q: t('faq.q1'), a: <>{t('faq.a1a')}<code>dsh plugin --profile web add github:losebird/dsh-plugin-market#v0.1.46</code>{t('faq.a1b')}</> },
