...
const INSTALL_SPEC = 'github:losebird/dsh-plugin-market#v0.1.9'
...
function Faq() {
  const { t } = useLang()
  const items = [
    { q: t('faq.q1'), a: <>{t('faq.a1a')}<code>dsh plugin --profile web add github:losebird/dsh-plugin-market#v0.1.9</code>{t('faq.a1b')}</> },
