...
export default class App extends PureComponent {
    ...
    render() {
        return (_jsx(TerminalWriteProvider, { value: this.writeRaw, children: _jsx(TerminalSizeContext.Provider, { value: {
    ...
    processInput = (input) => {
        ...
        if (this.keyParseState.incomplete) {
            ...
            this.incompleteEscapeTimer = setTimeout(this.flushIncomplete, this.keyParseState.mode === "IN_PASTE"
                ? this.PASTE_TIMEOUT
                : this.NORMAL_TIMEOUT);
        }
    };
